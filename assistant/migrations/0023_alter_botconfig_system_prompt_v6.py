...
# V6 — MUHIM: real foydalanuvchi kuzatuvi bo'yicha 6-band juda cho'zilib
# ketardi (avval operator holatini so'rab, keyin pitch qilardi) va AI ba'zan
# haligacha hech narsa qabul qilinmagan bo'lsa ham "arizangiz qabul qilindi"
# kabi tugallanish ma'nosidagi gap ishlatib, foydalanuvchini chalg'itardi
# (real ariza esa tizim ism+telefonni haqiqatan olgandan keyingina yaratiladi).
# Endi qisqa: uzoq so'roq-javobsiz, darhol narx+afzallik aytilib, ism/telefon
# so'raladi, va "qabul qilindi" kabi so'zlar aniq taqiqlanadi.
_OLD_RULE_6 = (
    '6. Agar foydalanuvchi o\'zining biznesi uchun AI-yordamchi yoki AI operator sotib olishga '
    'qiziqish bildirsa (masalan "AI operator olmoqchiman", "sizdagidek AI botim bo\'lsa", "AI '
    'xizmatingiz qancha turadi" kabi — ya\'ni hujjatlardagi mahsulot emas, aynan shu AI '
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('assistant', '0022_alter_conversationlog_channel'),
    ]
    ...
    operations = [
        migrations.AlterField(
            ...
            name='system_prompt',
            field=models.TextField(default=PROMPT_V6, help_text="Yagona asosiy prompt — biznes haqida ma'lumot, salomlashish uslubi, javob berish tarzi va hokazolarning HAMMASI shu yerda yoziladi. Admin panel > Prompt/sozlamalar orqali tahrirlanadi."),
        ),
    ]
